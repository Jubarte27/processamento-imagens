...
\lstinputlisting{floyd_steinberg.m}

\paragraph*{Código — Dithering de Bayer}
\lstinputlisting{bayer.m}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{resultados_dithering/raposa_comparacao_completa.png}
    \caption{Comparação visual entre métodos de Dithering}
    \label{fig:q4_comparacao_raposa}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{resultados_dithering/borboleta_comparacao_completa.png}
    \caption{Comparação visual entre métodos de Dithering}
    \label{fig:q4_comparacao_borboleta}
\end{figure}
