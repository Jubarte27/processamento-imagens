...
\begin{minipage}{\linewidth}
    \lstinputlisting[language=MATLAB]{adicao_de_ruido.m}
\end{minipage}
...
\begin{minipage}{\linewidth}
    \lstinputlisting[language=MATLAB]{alpha_trimmed_mean_filter.m}
\end{minipage}
...
\begin{minipage}{\linewidth}
    \lstinputlisting[language=MATLAB]{maina.m}
\end{minipage}
...
\begin{minipage}{\linewidth}
    \paragraph*{Código}
    \lstinputlisting[language=MATLAB]{mainb.m}
\end{minipage}
...
\figurescompare{borboleta,raposa}{}{.out/}{_25_05_unsharp}{Original}{Com Unsharp Masking}{sigma=2.5 e amount=0.5}{q3_25_05_unsharp}
...
\figurescompare{borboleta,raposa}{}{.out/}{_25_25_unsharp}{Original}{Com Unsharp Masking}{sigma=2.5 e amount=2.5}{q3_25_25_unsharp}
...
\figurescompare{borboleta,raposa}{}{.out/}{_05_25_unsharp}{Original}{Com Unsharp Masking}{sigma=0.5 e amount=2.5}{q3_05_25_unsharp}
